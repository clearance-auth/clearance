...
- [ ] Productize the authentication-security foundation: passkeys, factor policy, recovery, breached-password defense, lockout, digest-stored session secrets, rotating asymmetric access tokens, purpose-separated keys, and exact API/CLI workflows.
