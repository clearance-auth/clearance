 ...
 * @clearance/call's createMiddleware contract so the outer pipeline can merge them
 * into the response.
 */
 ...
 * mistake: @clearance/call's router skips an endpoint when its path is missing *or*
