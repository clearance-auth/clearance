...
import type { ClearancePluginDBSchema } from "../db";
import type { RawError } from "../utils/error-codes";
import type { AuthContext } from "./context";
import type { Awaitable, LiteralString } from "./helper";
import type { ClearanceOptions } from "./init-options";
...
export type ClearancePluginErrorCodePart = {
	/**
...
export type ClearancePlugin = ClearancePluginErrorCodePart & {
	id: LiteralString;
	 ...
	 * ```
	 */
	schema?: ClearancePluginDBSchema | undefined;
	/**
