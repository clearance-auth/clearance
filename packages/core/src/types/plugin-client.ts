...
export interface ClearanceClientOptions {
	fetchOptions?: ClientFetchOption | undefined;
	plugins?: ClearanceClientPlugin[] | undefined;
	baseURL?: string | undefined;
	basePath?: string | undefined;
	disableDefaultFetchPlugins?: boolean | undefined;
	$InferAuth?: ClearanceOptions | undefined;
...
export interface ClearanceClientPlugin {
	...
	getActions?: (
		...
		$store: ClientStore,
		/**
		 * clearance client options
		 */
		options: ClearanceClientOptions | undefined,
	) => Record<string, any>;
	/**
