...
> {
	 ...
	 *
	 * For example, MongoDB uses `_id` while in Clearance we use `id`.
	 *
	 *
	 * @example
	...
	customTransformInput?:
		| ((props: {
				...
				model: string;
				/**
				 * The schema of the user's Clearance instance.
				 */
				schema: ClearanceDBSchema;
				/**
				 * The options of the user's Clearance instance.
				 */
				options: Options;
		  }) => any)
		| undefined;
	 ...
	 * - If `generateId` is `false` in the user's Clearance config, then this option will be ignored.
...
export interface CustomAdapter {
	...
	createSchema?:
		| ((props: {
				...
				file?: string;
				/**
				 * The tables from the user's Clearance instance schema.
				 */
...
export interface DBAdapterInstance<
	Options extends ClearanceOptions = ClearanceOptions,
> {
	(options: ClearanceOptions): DBAdapter<Options>;
}
