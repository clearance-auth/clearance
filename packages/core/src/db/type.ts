...
export type InferDBFieldsFromOptionsInput<
	DBOptions extends
		| ClearanceOptions["session"]
		| ClearanceOptions["user"]
		| ClearanceOptions["verification"]
		| ClearanceOptions["account"]
		| ClearanceOptions["rateLimit"],
> = DBOptions extends {
...
export type ClearanceDBSchema = Record<
	string,
	{
		/**
