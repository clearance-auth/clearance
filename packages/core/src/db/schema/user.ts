...
/**
 * User schema type used by clearance, note that it's possible that user could have additional fields
 */
export type User<
	DBOptions extends ClearanceOptions["user"] = ClearanceOptions["user"],
