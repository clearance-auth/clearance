...
import type { ClearanceOptions } from "../../types/init-options";
import type {
...
/**
 * Account schema type used by clearance, note that it's possible that account could have additional fields
 */
export type Account<
	DBOptions extends ClearanceOptions["account"] = ClearanceOptions["account"],
