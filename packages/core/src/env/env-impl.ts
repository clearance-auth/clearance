...
/**
 * Common environment variables used in Clearance
 */
export const ENV = Object.freeze({
	get CLEARANCE_SECRET() {
		return getEnvVar("CLEARANCE_SECRET");
	},
	get AUTH_SECRET() {
		return getEnvVar("AUTH_SECRET");
	},
	get CLEARANCE_TELEMETRY() {
		return getEnvVar("CLEARANCE_TELEMETRY");
	},
	get CLEARANCE_TELEMETRY_ID() {
		return getEnvVar("CLEARANCE_TELEMETRY_ID");
	},
	get NODE_ENV() {
	...
	get CLEARANCE_TELEMETRY_ENDPOINT(): string | undefined {
		return getEnvVar(
			"CLEARANCE_TELEMETRY_ENDPOINT",
			import.meta.env.CLEARANCE_TELEMETRY_ENDPOINT,
		);
	},
});
