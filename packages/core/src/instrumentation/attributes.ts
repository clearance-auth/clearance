...
export const ATTR_OPERATION_ID = "clearance.operation_id" as const;

/** Hook type (e.g. before, after, create.before). */
export const ATTR_HOOK_TYPE = "clearance.hook.type" as const;

/** Execution context (e.g. user, plugin:id). */
export const ATTR_CONTEXT = "clearance.context" as const;
