...
const INSTRUMENTATION_SCOPE = "clearance";
const INSTRUMENTATION_VERSION = import.meta.env?.CLEARANCE_VERSION ?? "1.0.0";

/**
 * Clearance uses `throw ctx.redirect(url)` for flow control (e.g. OAuth
