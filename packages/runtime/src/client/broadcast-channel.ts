...
export const kBroadcastChannel = Symbol.for("clearance:broadcast-channel");
...
class WindowBroadcastChannel implements BroadcastChannel {
	...
	constructor(name = "clearance.message") {
		this.name = name;
	}
...
export function getGlobalBroadcastChannel(name = "clearance.message") {
