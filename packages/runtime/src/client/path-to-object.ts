...
import type { Endpoint, InputContext, StandardSchemaV1 } from "@clearance/call";
import type {
	HasRequiredKeys,
	IsAny,
	Prettify,
...
type ReplaceAuthUserAndSession<
	Data,
	ClientOpts extends ClearanceClientOptions,
...
export type InferRoute<API, COpts extends ClearanceClientOptions> =
