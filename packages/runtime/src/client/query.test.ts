...
describe("useAuthQuery - error handling", () => {
	...
	afterEach(() => {
		vi.useRealTimers();
		vi.restoreAllMocks();
		delete (globalThis as any)[Symbol.for("clearance:broadcast-channel")];
		delete (globalThis as any)[Symbol.for("clearance:focus-manager")];
		delete (globalThis as any)[Symbol.for("clearance:online-manager")];
	});
	 ...
	 * https://github.com/clearance-auth/clearance: multiple
