import type { ClearanceClientOptions } from "@clearance/core";
import type { BASE_ERROR_CODES } from "@clearance/core/error";
import { capitalizeFirstLetter } from "@clearance/core/utils/string";
import type {
	BetterFetchError,
	BetterFetchResponse,
...
type InferResolvedHooks<O extends ClearanceClientOptions> = O extends {
...
type ClientSession<Option extends ClearanceClientOptions> =
...
type VueUseSession<Option extends ClearanceClientOptions> = {
	(): DeepReadonly<
		Ref<{
 ...
 */
export type VueAuthClient<Option extends ClearanceClientOptions> =
...
export function createAuthClient<Option extends ClearanceClientOptions>(
