...
import { normalizePathname } from "@clearance/core/utils/url";
import type { Endpoint, Middleware } from "@clearance/call";
import { createRouter } from "@clearance/call";
...
export function getEndpoints<Option extends ClearanceOptions>(
...
export const router = <Option extends ClearanceOptions>(
	ctx: AuthContext,
	options: Option,
) => {
...
export { APIError } from "@clearance/core/error";
export { getIp } from "@clearance/core/utils/ip";
