...
import { isProduction } from "@clearance/core/env";
...
>
    ${
            ...
            ${
							!description
								? "We encountered an unexpected error. Please try again or return to the home page. If you're a developer, you can find " +
									`<a href='https://github.com/clearance-auth/clearance)}' target='_blank' rel="noopener noreferrer" style='color: var(--foreground); text-decoration: underline;'>more information about the error</a>.`
								: description
						}
          </p>
        </div>
        ...
        >
          ...
          <a
            href="https://github.com/clearance-auth/clearance)}?askai=${encodeURIComponent(`What does the error code ${code} mean?`)}"
            target="_blank"
