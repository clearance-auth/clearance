import type { OAuth2Tokens, OAuth2UserInfo } from "@clearance/core/oauth2";
 ...
 * @example
 * ```ts
 * import { genericOAuth, microsoftEntraId } from "@clearance/runtime/plugins/generic-oauth";
 *
 * export const auth = clearance({
 *   plugins: [
 *     genericOAuth({
 *       config: [
 *         microsoftEntraId({
