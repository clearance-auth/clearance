import type { AuthContext, ClearanceOptions } from "@clearance/core";
import type {
	DBFieldAttribute,
...
export async function generator(ctx: AuthContext, options: ClearanceOptions) {
		...
		tags: [
			{
				name: "Default",
				description:
					"Default endpoints that are included with Clearance by default. These endpoints are not part of any plugin.",
			},
		],
		paths,
	};
