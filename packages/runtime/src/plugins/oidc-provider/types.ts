...
export interface AuthorizationQuery {
	 ...
	 *
	 * Note: Clearance stores the state in a database instead of a cookie. - This is to minimize
	 ...
	 * designation).
	 *
	 * Clearance does not support this parameter yet. It'll not throw an error if it's provided,
	 *
