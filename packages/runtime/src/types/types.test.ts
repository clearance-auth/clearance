...
import type { GoogleProfile, JoinConfig, JoinOption } from "@clearance/runtime/types";
import { describe, expect, expectTypeOf, it } from "vitest";
import { createAuthEndpoint } from "../api";
import { clearance } from "../auth/minimal";
...
describe("general types", async () => {
	...
	it("should keep getSession on auth.api when O is a generic parameter", () => {
		async function probe<O extends ClearanceOptions>(auth: Auth<O>) {
...
describe("plugin types through factory and indirection patterns", () => {
	...
	it("preserves $ERROR_CODES through factory ReturnType", () => {
		const createAuth = () => clearance({ plugins: [admin()] });
...
describe("public type exports", () => {
	it("should export JoinOption from clearance/types", () => {
		expectTypeOf<JoinOption>().not.toBeAny();
	});

	it("should export JoinConfig from clearance/types", () => {
		expectTypeOf<JoinConfig>().not.toBeAny();
	});

	it("should export GoogleProfile from clearance/types", () => {
