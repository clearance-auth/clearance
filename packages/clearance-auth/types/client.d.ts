...
export declare function createAuthClient<Options extends ClearanceAuthClientOptions = ClearanceAuthClientOptions>(options?: Options): ClearanceBaseAuthClient;
