import type { KeyProviderReadiness, KeyProviderRegistry, KeyPurpose, KeySigningProvider } from "@clearance/key-management";
...
export type ClearanceAuthenticationAssuranceLevel = "single_factor" | "multi_factor" | "phishing_resistant";
export type ClearanceAuthenticationPolicy = Readonly<{
    ...
    allowedFactors: Readonly<{
        totp: boolean;
        passkey: boolean;
    }>;
    trustedDevice: Readonly<{
        enabled: boolean;
...
export type ClearanceTransactionQuery = Readonly<{
    rawTransactionQuery<Row extends Record<string, unknown> = Record<string, unknown>>(text: string, values?: readonly unknown[]): Promise<{
        rows: Row[];
...
export type ClearanceKeyManagementFacade = Readonly<{
    ...
    resourceId(purpose: KeyPurpose, identity: Readonly<Record<string, string | null>>): string;
    sealText(purpose: KeyPurpose, resourceId: string, plaintext: string): Promise<string>;
    openText(purpose: KeyPurpose, resourceId: string, envelope: string): Promise<string>;
...
export type ClearanceAuthenticationPolicyApplyResult = ClearanceAuthenticationPolicyPlanResult & Readonly<{
    changed: boolean;
...
export type ClearanceAuthenticationUnlockResult = ClearanceAuthenticationUnlockPreview & Readonly<{
    changed: boolean;
}>;
...
export type ClearanceAuthenticationPolicyCandidateInput = Readonly<{
