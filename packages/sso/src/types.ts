import type { Awaitable, OAuth2Tokens, User } from "@clearance/runtime";
...
export interface SSOOptions {
	...
	saml?: {
		 ...
		 * assertions without NotOnOrAfter are rejected.
		 *
		 * When disabled (default), assertions without timestamps are accepted but
		 * a warning is logged; individual timestamp conditions are still validated
		 * when present.
		 *
		 * **SAML Spec Notes:**
