 ...
 *
 * Required fields for Clearance's OIDC support:
 * - issuer
...
export type DiscoveryErrorCode =
	...
	/** IdP only advertises token auth methods that Clearance doesn't currently support */
 ...
 *
 * Field names are camelCase to match Clearance conventions.
 */
